...
$no=1;
          ...
          echo '<td>'.$data['img'].'</td>';
          echo '<td>'.$data['url'].'</td>';
          echo '<td style="float: right">      <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#myModal'.$data['id'].'"><i class="fa fa-edit"></i> Edit</button>
          <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#myModaldelete'.$data['id'].'"><i class="fa fa-trash"></i> Delete</button></td>';
