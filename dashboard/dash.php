...
<div id="navbar" class="navbar">
  <div class="navbar-left">
    <a id="brand" class="text-center" href="./?session=Soda2a-ip150">X-Radius</a>
...
<div id="sidenav" class="sidenav">
  ...
  <a href="./?session=Soda2a-ip150" class="menu active"><i class="fa fa-dashboard"></i> Dashboard</a>
  <!--hotspot-->
  ...
  <!--quick print-->
  <a href="./?hotspot=quick-print&session=Soda2a-ip150" class="menu "> <i class="fa fa-print"></i> Quick Print </a>
  <!--vouchers-->
  <a href="./?hotspot=users-by-profile&session=Soda2a-ip150" class="menu "> <i class="fa fa-ticket"></i> Vouchers </a>
   <!--log-->
  ...
  <div class="dropdown-container ">
    <a href="./?system=scheduler&session=Soda2a-ip150" class=""> <i class="fa fa-clock-o "></i> Scheduler </a>
  ...
  <!--dhcp leases-->
  <a href="./?hotspot=dhcp-leases&session=Soda2a-ip150" class="menu "><i class=" fa fa-sitemap"></i> DHCP Leases</a>
  <!--traffic monitor-->
  <a href="./?interface=traffic-monitor&session=Soda2a-ip150" class="menu "><i class=" fa fa-area-chart"></i> Traffic Monitor</a>
  <!--report-->
  <a href="./?report=selling&idbl=sep2022&session=Soda2a-ip150" class="menu "><i class="nav-icon fa fa-money"></i> Report</a>
  <!--settings-->
  ...
  <!--about-->
  <a href="./?hotspot=about&session=Soda2a-ip150" class="menu "><i class="fa fa-info-circle"></i> About</a>
            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <script type="text/javascript"> 
                    var chart;
                    var sessiondata = "Soda2a-ip150";
                    var interface = "ether1";
                    var n = 3000;
